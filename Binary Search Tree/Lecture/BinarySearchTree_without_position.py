...
def main():
    ...
    node_contains_4 = test.get_node(4)
    print("Before 4:", test.before(node_contains_4)._element)
    print("After 4:", test.after(node_contains_4)._element)
    test.delete(node_contains_4)
    for each in reversed(test):
        print(each, end = " ")
    print()
    for each in (test):
        print(each, end = " ")
    print()
    print("First:", test.first()._element)
    print("Last:", test.last()._element)
